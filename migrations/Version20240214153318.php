 ...
 */
final class Version20240214153318 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, utilisateur_id INT NOT NULL, wish_list_id INT DEFAULT NULL, titre_produit VARCHAR(255) NOT NULL, description_produit LONGTEXT NOT NULL, photo VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, choix_echange TINYINT(1) NOT NULL, etat VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, INDEX IDX_29A5EC27BCF5E72D (categorie_id), INDEX IDX_29A5EC27FB88E14F (utilisateur_id), INDEX IDX_29A5EC27D69F3311 (wish_list_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
